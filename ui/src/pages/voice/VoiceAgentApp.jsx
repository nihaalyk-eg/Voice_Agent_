          ...
          <div className="settings-overlay" onClick={() => setSettingsOpen(false)}>
            <div className="settings-panel" onClick={e => e.stopPropagation()}>
              ...
              <div className="erp-card" style={{ marginBottom: '16px' }}>
                ...
                {config.configMode === 'cdb' && <div style={{ fontSize: '11.5px', color: 'var(--text-muted)', lineHeight: 1.5 }}>Dial a number in the Caller ID box on the main screen to match the caller instantly... Admin options for the Customer DB connection have moved to the <b>Customer DB</b> tab in the sidebar.</div>}
              </div>
