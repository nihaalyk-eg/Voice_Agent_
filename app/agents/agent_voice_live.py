...
from app.tools import realtime_tools
...
def _load_prompt() -> str:
    prompt_path = _Path(__file__).parent.parent.parent / "prompts" / "system_prompt.txt"
    try:
        return prompt_path.read_text(encoding="utf-8").strip()
    except Exception:
        return "You are a helpful, concise voice assistant."
